...
const ProjectTextbox = ({ project, reversed }: { project: ProjectType; reversed: boolean }) => {
    ...
    return (
        <div className="relative min-w-[25%]">
            <div
                className={`top-1/2 z-10 flex flex-col rounded-md border bg-white px-10 py-5 text-black md:absolute md:-translate-y-1/2 md:rounded-lg ${
                ...
                <div className="mt-2 flex w-full justify-end gap-2">
                    {project.githubUrl && (
                        ...
                        >
                            <AiFillGithub
                                size={28}
                                className="hover:fill-primary transition-colors duration-500"
                            />
                        </a>
                    )}
                    <a
...
const Project = ({ project, reversed }: { project: ProjectType; reversed: boolean }) => {
    return (
